...
(struct dual-number (epsilon primal perturbation))
...
;; Quick adaption to existing code.  Clean pass later. RPR
(define gsl-lngamma fllog-gamma)
(define make-tape tape)
(define make-dual-number dual-number)
